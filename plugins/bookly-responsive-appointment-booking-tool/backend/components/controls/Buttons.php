...
class Buttons
{
     ...
     * @param bool $ellipsis
     */
    public static function renderGenerateDelete( $id = 'bookly-generate-delete', $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = true )
    {
        echo self::_createButton(
            'button',
            $id,
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Generated Invoice Delete', 'bookly' ),
            '{caption}' . ( $ellipsis ? '…' : '' ),
            '<i class="far fa-fw fa-trash-alt mr-lg-1"></i>',
            true
        );
     ...
     * @param bool $ellipsis
     */
    public static function renderMasterDelete( $id = 'bookly-master-delete', $extra_class = null, $caption = null, array $attrs = array(), $ellipsis = true )
    {
        echo self::_createButton(
            'button',
            $id,
            ...
            $extra_class,
            $attrs,
            $caption !== null ? $caption : __( 'Master Invoice Delete', 'bookly' ),
            '{caption}' . ( $ellipsis ? '…' : '' ),
            '<i class="far fa-fw fa-trash-alt mr-lg-1"></i>',
            true
        );
