...
<?php Selects::renderSingle( 'bookly_auto_change_status', __( 'Automatically change status of appointment', 'bookly' ), __( 'If enabled, initial status of the appointment will be changed to the status set in the "Status to be set" field after the appointment has been completed.', 'bookly' ) ) ?>
<div class="border-left mt-3 ml-4 pl-3 bookly-js-auto-change-status">
